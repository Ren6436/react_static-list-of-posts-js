...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>{const{email:t,body:i,name:n}=e;return O.jsxs("div",{className:"CommentInfo",children:[O.jsxs("div",{className:"CommentInfo__title",children:[O.jsx("strong",{className:"CommentInfo__name",children:n})," by ",O.jsx("a",{className:"CommentInfo__email",href:`mailto:${t}`,children:t})]}),O.jsx("div",{className:"CommentInfo__body",children:i})]})},Lc=({comments:e})=>O.jsx("div",{className:"CommentList",children:e.map(t=>O.jsx(Pc,{comment:t},t.id))}),Tc=({user:e})=>O.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Mc=({post:e})=>{const{title:t,user:i,comments:n,body:a}=e;return O.jsxs("div",{className:"PostInfo",children:[O.jsxs("div",{className:"PostInfo__header",children:[O.jsx("h3",{className:"PostInfo__title",children:t}),O.jsxs("p",{children:[" Posted by  ",O.jsx(Tc,{user:i})]})]}),O.jsx("p",{className:"PostInfo__body",children:a}),O.jsx("hr",{}),n.length===0?O.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):O.jsx(Lc,{comments:n})]})},Rc=({posts:e})=>O.jsx("div",{className:"PostList",children:e.map(t=>O.jsx(Mc,{post:t}))});function Dc(e){return Nc.find(t=>t.id===e)||null}const jc=Cc.map(e=>({...e,user:Dc(e.userId),comments:zc.filter(t=>t.postId===e.id)})),Oc=()=>O.jsxs("section",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Static list of posts"}),O.jsx(Rc,{posts:jc})]});em(document.getElementById("root")).render(O.jsx(Oc,{}));
